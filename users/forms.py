...
class SettingsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
                ...
                """),
                Field("trade_list_description",placeholder="Welcome to my price list. Click Start Trade now to start a trade. (Emojis are allowed 🤑) "),
...
Hi [[seller_name]], thank you for the trade, the total is $[[total]], here is your receipt [[receipt_link]]. This is our trade N[[trade_number]]. Don't forget to rate my price list [[prices_link]]. Have a nice day!'''),
                ...
                Field(PrependedText('link_to_forum_post', 'https:www.torn.com/'), placeholder='To'),
                #### Job Seeking Tab #### 
                HTML("</div>"),
                HTML("""
                ...
                Field('job_seeking'),
                Field('job_message',placeholder='Looking for 3* AN send me your offers'),
                HTML("</div>"),
                #### Selling Revives Tab #### 
                HTML("""
                <div class="tab-pane fade" id="revivers" role="tabpanel" aria-labelledby="revivers-tab">"""),
                Field('selling_revives'),Field('revives_message',placeholder='Reviving for $1m or 1 Xanax.'),
                HTML("</div>"),
                #### Selling Losses Tab #### 
                HTML("""
                <div class="tab-pane fade" id="losses" role="tabpanel" aria-labelledby="losses-tab">"""),
                Field('selling_losses'),Field('losses_message', placeholder='Selling losses 300k each.'),
                HTML("</div>"),
                #### Selling Company Tab #### 
                HTML("""
                <div class="tab-pane fade" id="selling_company" role="tabpanel" aria-labelledby="selling_company-tab">"""),
                Field('selling_company'),Field('selling_company_price_negotiable', label='Price negotiable?')
                ,Field(PrependedAppendedText('selling_company_asking_price','$','M')),Field('selling_company_description'),
                HTML("</div>"),
                #### Company Looking to Hire Tab #### 
                HTML("""
                <div class="tab-pane fade" id="company_hiring" role="tabpanel" aria-labelledby="company_hiring-tab">"""),
                Field('company_looking_to_hire'),Field('company_looking_to_hire_message'),
                HTML("</div>"),
                HTML("""
