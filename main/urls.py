...
urlpatterns = [
    ...
    path('delete_receipt/<str:receipt_id>/', views.delete_receipt_from_profile,name='delete_receipt'),
    ...
    path('extension_get_prices',views.extension_get_prices,name='extension_get_prices'),
    path('new_extension_get_prices',views.new_extension_get_prices,name='new_extension_get_prices'),
