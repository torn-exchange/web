...
def test_parse_trade_text():
    ...
    assert parse_trade_text(test_string_2) == ('Ata',['ArmaLite M-15A4','Enfield SA-80','Dual 92G Berettas','Type 98 Anti Tank','MP3 Player','RS232 Cable'],[913,110929,2023,11,12,1])
    assert parse_trade_text(test_string_3) == ('Ata2123aax2as12',['ArmaLite M-15A4','Enfield SA-80','Dual 92G Berettas','Type 98 Anti Tank','MP3 Player','RS232 Cable'],[913,110929,2023,11,12,1])
    assert parse_trade_text(test_string_4) == ('LDOC',['Bottle of Pumpkin Brew','Bottle of Tequila', 'Bottle of Wicked Witch', 'Can of Crocozade', 'Can of Damp Valley'], [1,29,49,21,103])